  ...
  return (
    <>
      <div className="flex flex-row items-center justify-around p-5 w-full -mt-14 mx-auto">
        <div className="hidden lg:flex jsutify-start font-[600]">
          <p>EGP</p>
        </div>
        <div
          className="flex lg:hidden cursor-pointer font-[600] text-3xl"
          onClick={() => setIsOpen(true)}
        >
          <FaBars className="hover:text-[var(--hover-color)]" />
