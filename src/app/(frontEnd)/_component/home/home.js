    ...
    <div className="flex flex-col lg:flex-row justify-around items-center gap-5 h-full w-full bg-gradient-to-br from-[#0B0C10] via-[#1F2833] to-[#2C3E50] mt-10 p-8">
      ...
      <div className="flex-1 flex items-center justify-center lg:justify-start px-4">
        <div className="text-white text-center lg:text-left">
          ...
          <div className="text-center lg:text-left flex flex-col items-center lg:items-start mt-2">
            <p className="text-xl md:text-2xl lg:text-3xl font-bold flex flex-col md:flex-row items-center justify-center lg:justify-start">
              Best
              <span className="text-[var(--hover-color)] md:inline block md:ml-2">
                Laptops!
              </span>
            </p>
            <p className="text-sm md:text-base lg:text-lg flex flex-col md:flex-row items-center justify-center lg:justify-start mt-2">
