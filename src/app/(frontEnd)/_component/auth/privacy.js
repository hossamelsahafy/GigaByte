const Privacy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to GigaByte, Egypt, Damietta.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GigaByte, accessible from{" "}
            <a
              href="https://giga-byte-sepia.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://giga-byte-sepia.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: gigabyte.info.010@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://giga-byte-sepia.vercel.app/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://giga-byte-sepia.vercel.app/contact-us
            </a>
          </p>
        </li>
      </ul>
