...
const Privacy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to GigaByte Damietta.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GigaByte Damietta, accessible
            from{" "}
            <a
              href="https://giga-byte-lilac.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://giga-byte-lilac.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: gigabyte.info.010@gmail.com</li>
      </ul>
    </div>
  );
};
